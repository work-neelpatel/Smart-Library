<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Students.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
                    <div class="container-fluid">
                        <div class="form-inline mb-4">
                            <h1 class="mt-4 col-xl-12 pl-0">Students</h1>
                        </div>
                        <div class="form-inline mb-4 pb-2 border-bottom border-secondary">
                            ...
                            <div class="col-xl-8 px-0 col-sm-8 col-4">
                                <asp:LinkButton ID="Search_Student" runat="server" 
                                    class="btn btn-outline-primary float-right text-decoration-none" onclick="Search_Student_Click" 
                                    >Search<i class="ml-2 fa fa-search" aria-hidden="true"></i></asp:LinkButton>
                            </div>
                        </div>
                        <div class="card mb-4">
